...
Продукт должен отвечать на этот вопрос через объяснимую рекомендацию, основанную на нагрузке, восстановлении и контексте дня.

---

## 2. System role

Whatte — это не просто хранилище данных.
